...
public interface GraphQLObjectTypeRepository extends Repository<GraphQLObjectType, GraphQLObjectTypeDto, String> {

    List<GraphQLObjectTypeDto> findWithApplicationId(String applicationId);
