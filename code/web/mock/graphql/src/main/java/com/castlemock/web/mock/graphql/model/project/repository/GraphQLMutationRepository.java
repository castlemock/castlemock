...
public interface GraphQLMutationRepository extends Repository<GraphQLMutation, GraphQLMutationDto, String> {

    List<GraphQLMutationDto> findWithApplicationId(String applicationId);
