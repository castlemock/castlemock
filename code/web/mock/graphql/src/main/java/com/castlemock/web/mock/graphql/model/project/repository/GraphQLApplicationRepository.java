...
public interface GraphQLApplicationRepository extends Repository<GraphQLApplication, GraphQLApplicationDto, String> {

    List<GraphQLApplicationDto> findWithProjectId(String projectId);
