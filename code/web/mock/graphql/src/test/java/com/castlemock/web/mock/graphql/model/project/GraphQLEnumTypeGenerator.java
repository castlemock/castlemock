 ...
 * @since 1.0
 */
public class GraphQLEnumTypeGenerator {

    public static GraphQLEnumType generateGraphQLEnumType(){
        final GraphQLEnumType enumType = new GraphQLEnumType();
        enumType.setId("GRAPHQL ENUM TYPE");
        enumType.setName("Enum type name");
        enumType.setDescription("Description");
        enumType.setApplicationId("ApplicationId");
        enumType.setDefinitions(new ArrayList<GraphQLEnumValueDefinition>());
        return enumType;
    }
