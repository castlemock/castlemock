 ...
 * from this class because the {@link com.fortmocks.web.mock.rest.web.rest.controller.RestControllerAdvice} will
 * only handle exceptions that is either an instance of the RestException class or an instance from a class that
 * is inherit from the RestException class. The {@link com.fortmocks.web.mock.rest.web.rest.controller.RestControllerAdvice}
 * will transform the exception message into a REST response message. If an exception is thrown from the
 * {@link com.fortmocks.web.mock.rest.web.rest.controller.RestServiceController}, the {@link ViewControllerAdvice}
 * will process the exception instead and a view will be sent as a response instead.
 * @author Karl Dahlgren
 * @since 1.0
 * @see com.fortmocks.web.mock.rest.web.rest.controller.RestControllerAdvice
