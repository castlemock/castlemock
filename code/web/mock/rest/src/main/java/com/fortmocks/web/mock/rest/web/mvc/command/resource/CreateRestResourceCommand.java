...
package com.fortmocks.web.mock.rest.web.mvc.command.resource;
 ...
 * @since 1.0
 */
public class CreateRestResourceCommand {

    private RestResourceDto restResource = new RestResourceDto();
