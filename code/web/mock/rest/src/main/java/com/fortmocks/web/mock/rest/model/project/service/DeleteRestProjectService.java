...
import com.fortmocks.core.mock.rest.model.project.service.message.input.DeleteRestProjectInput;
import com.fortmocks.core.mock.rest.model.project.service.message.output.DeleteRestProjectOutput;
...
public class DeleteRestProjectService extends AbstractRestProjectService implements Service<DeleteRestProjectInput, DeleteRestProjectOutput> {
    ...
    public ServiceResult<DeleteRestProjectOutput> process(final ServiceTask<DeleteRestProjectInput> serviceTask) {
        ...
        return createServiceResult(new DeleteRestProjectOutput());
    }
}
