    ...
    <section>
        ...
        <div class="content-summary">
            <table class="formTable">
                ...
                <tr>
                    <td class="column1"><label path="defaultResponse"><spring:message code="rest.restmethod.label.defaultresponse"/></label></td>
                    <td class="column2"><label path="defaultResponse">${restMethod.defaultResponseName}</label></td>
                </tr>
                <tr>
