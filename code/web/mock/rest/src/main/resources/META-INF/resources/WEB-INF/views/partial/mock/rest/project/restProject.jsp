        ...
        <sec:authorize access="hasAuthority('ADMIN') or hasAuthority('MODIFIER')">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <a class="button-secondary pure-button" href="<c:url value="/web/rest/project/${restProject.id}/add/swagger"/>"><i class="fa fa-upload"></i> <span><spring:message code="rest.restproject.button.upload" arguments="swagger"/></span></a>
                </c:otherwise>
            </c:choose>
