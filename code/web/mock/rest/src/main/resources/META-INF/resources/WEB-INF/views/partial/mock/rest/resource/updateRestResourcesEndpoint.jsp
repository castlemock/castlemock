        ...
        <c:choose>
            <c:when test="${restResources.size() > 0}">
                ...
                <form:form action="${update_resources_endpoint_url}" method="POST" modelAttribute="updateRestResourcesEndpointCommand">
                    ...
                    <a href="<c:url value="/web/rest/project/${restProjectId}/application/${restApplicationId}"/>" class="btn btn-primary"><i class="fas fa-times"></i> <spring:message code="rest.updaterestresourcesendpoint.button.cancel"/></a>
                </form:form>
            </c:when>
            <c:otherwise>
