                    ...
                    <c:when test="${soapOperation.mockResponses.size() > 0}">
                        <form:form action="${soap_mock_response_update_url}" method="POST"  modelAttribute="soapMockResponseModifierCommand">
                            ...
                            <sec:authorize access="hasAuthority('ADMIN') or hasAuthority('MODIFIER')">
                                ...
                                <button class="btn btn-primary demo-button-disabled" type="submit" name="action" value="duplicate"><i class="fa fa-copy"></i> <span><spring:message code="soap.soapoperation.button.duplicate"/></span></button>
