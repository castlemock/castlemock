    ...
    <section>
        ...
        <form:form action="${create_soap_mock_response_url}" method="POST">
                ...
                <div id="tab-headers" class="tab-pane fade">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <button class="btn btn-success" onclick="addHeader()" type="button"><i class="fas fa-plus"></i>  <span><spring:message code="soap.createsoapmockresponse.button.addheader"/></span></button>
                        </div>
                    </div>
            ...
            <sec:authorize access="hasAuthority('ADMIN') or hasAuthority('MODIFIER')">
                <button class="btn btn-success" type="submit" name="submit"><i class="fas fa-plus"></i>  <span><spring:message code="soap.createsoapmockresponse.button.createmockresponse"/></span></button>
            </sec:authorize>
