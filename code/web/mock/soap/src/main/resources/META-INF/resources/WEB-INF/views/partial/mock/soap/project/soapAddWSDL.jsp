    ...
    <section>
        ...
        <div class="upload-link">
            ...
            <form:form method="POST" action="${add_wsdl_url}" modelAttribute="uploadForm">
                ...
                <button class="btn btn-success" type="submit" name="type" value="link"><i class="fas fa-upload"></i> <span><spring:message code="soap.soapaddwsdl.button.linkwsdl"/></span></button>
        ...
        <div class="upload-file">
            <form:form method="POST" enctype="multipart/form-data" action="${add_wsdl_url}" modelAttribute="uploadForm">
                ...
                <button class="btn btn-success" name="type" value="file"><i class="fas fa-upload"></i> <span><spring:message code="soap.soapaddwsdl.button.uploadfiles"/></span></button>
                <a href="<c:url value="/web/soap/project/${soapProjectId}"/>" class="btn btn-primary"><i class="fas fa-times"></i> <spring:message code="soap.soapaddwsdl.button.cancel"/></a>
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            </form:form>
        </div>
    </section>
