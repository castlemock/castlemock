...
package com.fortmocks.core.basis.model.user.service.message.output;
 ...
 * @since 1.0
 * @see com.fortmocks.core.basis.model.user.service.message.input.UpdateUserInput
 */
public class UpdateUserOutput implements Output {
    ...
    public UpdateUserOutput(UserDto updatedUser) {
