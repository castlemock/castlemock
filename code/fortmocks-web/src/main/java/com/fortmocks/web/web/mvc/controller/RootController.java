 ...
 * The reason for why this is needed is because Fort Mocks has various root URLs
 * that are used for various reasons, such as SOAP and REST interaction. However,
 * when the user tries to access Fort Mocks in the root context path, they should
...
public class RootController extends AbstractViewController {
    ...
    /**
     * Redirect the user to the main page for Fort Mocks
     * @return A view that redirects the user to the main page for Fort Mocks
     */
