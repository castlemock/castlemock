...
package com.fortmocks.web.web.mvc.controller.project;

import com.fortmocks.core.model.project.dto.ProjectDto;
import com.fortmocks.web.model.project.service.ProjectServiceFacadeImpl;
...
public class UpdateProjectController extends AbstractViewController {
    ...
    private static final String PAGE = "core/project/updateProject";
    ...
    public ModelAndView defaultPage(@PathVariable final String projectType, @PathVariable final Long projectId) {
    ...
    public ModelAndView update(@PathVariable final String projectType, @PathVariable final Long projectId, @ModelAttribute final ProjectDto updatedProject) {
