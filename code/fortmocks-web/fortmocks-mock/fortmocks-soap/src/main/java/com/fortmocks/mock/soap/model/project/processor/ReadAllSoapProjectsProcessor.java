 ...
 */
@Service
public class ReadAllSoapProjectsProcessor extends AbstractSoapProjectProcessor implements Processor<ReadAllSoapProjectsInput, ReadAllSoapProjectsOutput> {
