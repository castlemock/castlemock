 ...
 */
@Service
public class ReadSoapOperationWithTypeProcessor extends AbstractSoapProjectProcessor implements Processor<ReadSoapOperationWithTypeInput, ReadSoapOperationWithTypeOutput> {
