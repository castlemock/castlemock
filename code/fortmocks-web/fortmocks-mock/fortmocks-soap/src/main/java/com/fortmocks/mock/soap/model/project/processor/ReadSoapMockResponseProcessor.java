 ...
 */
@Service
public class ReadSoapMockResponseProcessor extends AbstractSoapProjectProcessor implements Processor<ReadAllSoapProjectsInput, ReadAllSoapProjectsOutput> {
