...
public class GraphQLObjectTypeDynamoRepository extends AbstractGraphQLTypeDynamoRepository<GraphQLObjectTypeDynamoRepository.GraphQLObjectTypeDocument, GraphQLObjectType> implements GraphQLObjectTypeRepository {

    @Autowired
    public GraphQLObjectTypeDynamoRepository(DozerBeanMapper mapper, AmazonDynamoDB amazonDynamoDB, DynamoDBMapperConfig dynamoDBMapperConfig) {
        super(mapper, amazonDynamoDB, dynamoDBMapperConfig);
    }

    public GraphQLObjectTypeDynamoRepository(DozerBeanMapper mapper, AmazonDynamoDB amazonDynamoDB) {
    ...
    public List<GraphQLObjectType> search(SearchQuery query) {
        List<GraphQLObjectTypeDocument> operations =
    ...
    public List<GraphQLObjectType> findWithApplicationId(final String applicationId) {
        List<GraphQLObjectTypeDocument> responses =
                dynamoDBMapper.scan(entityClass,
    ...
    @DynamoDBTable(tableName = "graphQLObjectType")
    public static class GraphQLObjectTypeDocument extends AbstractGraphQLTypeDynamoRepository.GraphQLTypeDocument {
