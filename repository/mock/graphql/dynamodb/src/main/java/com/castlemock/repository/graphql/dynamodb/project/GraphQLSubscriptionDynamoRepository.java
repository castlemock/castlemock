...
public class GraphQLSubscriptionDynamoRepository extends AbstractGraphQLOperationDynamoRepository<GraphQLSubscriptionDynamoRepository.GraphQLSubscriptionDocument, GraphQLSubscription> implements GraphQLSubscriptionRepository {

    @Autowired
    public GraphQLSubscriptionDynamoRepository(DozerBeanMapper mapper, AmazonDynamoDB amazonDynamoDB, DynamoDBMapperConfig dynamoDBMapperConfig) {
        super(mapper, amazonDynamoDB, dynamoDBMapperConfig);
    }

    public GraphQLSubscriptionDynamoRepository(DozerBeanMapper mapper, AmazonDynamoDB amazonDynamoDB) {
    ...
    public List<GraphQLSubscription> search(SearchQuery query) {
        List<GraphQLSubscriptionDocument> operations =
    ...
    public List<GraphQLSubscription> findWithApplicationId(final String applicationId) {
        List<GraphQLSubscriptionDocument> responses =
                dynamoDBMapper.scan(entityClass,
    ...
    @DynamoDBTable(tableName = "graphQLSubscription")
    public static class GraphQLSubscriptionDocument extends AbstractGraphQLOperationDynamoRepository.GraphQLOperationDocument {
