...
class CreateMethodModal extends PureComponent {
    ...
    onCreateMethodClick() {
        axios
            .post("/api/rest/rest/project/" + this.props.projectId + "/application/" + this.props.applicationId + "/resource/" + this.props.resourceId + "/method", this.state.newMethod)
            .then(response => {
                ...
                <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-success" data-dismiss="modal" onClick={this.onCreateMethodClick}>Create</button>
                        </div>
                    </div>
                </div>
            </div>
