...
class DeleteMockResponseModal extends PureComponent {
    ...
    onDeleteMockResponseClick() {
        axios
            .delete("/api/rest/rest/project/" + this.props.projectId + "/application/" + this.props.applicationId + "/resource/" + this.props.resourceId + "/method/" + this.props.methodId + "/mockresponse/" + this.props.mockResponseId)
            .then(response => {
