...
class DuplicateMockResponsesModal extends PureComponent {
    ...
    constructor(props) {
        super(props);
        this.onDuplicateMockResponsesClick = this.onDuplicateMockResponsesClick.bind(this);
    ...
    onDuplicateMockResponsesClick() {
        let mockResponseIds = this.props.selectedMockResponses.map(mockResponse => mockResponse.id);
        axios
            .post("/castlemock/api/rest/rest/project/" + this.props.projectId + "/application/" + this.props.applicationId +
    ...
    render() {
        return (
            <div className="modal fade" id="duplicateMockResponsesModal" tabIndex="-1" role="dialog"
                 aria-labelledby="duplicateMockResponsesModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="duplicateMockResponsesModalLabel">Duplicate responses?</h5>
...
export default DuplicateMockResponsesModal;