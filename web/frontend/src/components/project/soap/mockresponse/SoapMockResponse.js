...
class SoapMockResponse extends PureComponent {
    ...
    onUpdateMockResponseClick() {
        axios
            .put("/api/rest/soap/project/" + this.state.projectId + "/port/" + this.state.portId + "/operation/" + this.state.operationId + "/mockresponse/" + this.state.mockResponseId, this.state.updateMockResponse)
            .then(__ => {
