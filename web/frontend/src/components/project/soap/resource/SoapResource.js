...
class SoapResource extends PureComponent {
    ...
    getResource() {
        axios
            .get(process.env.PUBLIC_URL + "/api/rest/soap/project/" + this.state.projectId + "/resource/" + this.state.resourceId)
            .then(response => {
                this.setState({
    ...
    getResourceContent() {
        axios
            .get(process.env.PUBLIC_URL + "/api/rest/soap/project/" + this.state.projectId + "/resource/" + this.state.resourceId + "/content")
            .then(response => {
                this.setState({
