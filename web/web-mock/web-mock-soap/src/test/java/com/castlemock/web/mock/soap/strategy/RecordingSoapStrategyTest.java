...
class RecordingSoapStrategyTest {
    ...
    void testProcessOkForward() {
        ...
        final RecordingSoapStrategy strategy = new RecordingSoapStrategy(soapClient, mockStrategyResultFactory);
        ...
        Assertions.assertEquals(1, result.getPostServiceRequests().size());
