...
public final class UpdateRestMockResponseRequestTestBuilder {

    private UpdateRestMockResponseRequestTestBuilder() {

    }

    public static UpdateRestMockResponseRequest.Builder builder() {
        return UpdateRestMockResponseRequest
                .builder()
    ...
    public static UpdateRestMockResponseRequest build() {
