...
import com.castlemock.web.mock.rest.model.CreateRestMockResponseRequestTestBuilder;
...
class CreateRestMockResponseRequestConverterTest {

    @Test
    @DisplayName("To CreateRestMockResponseInput")
    void testToCreateRestMockResponseInput() {
        final String projectId = UUID.randomUUID().toString();
        final String applicationId = UUID.randomUUID().toString();
        final String resourceId = UUID.randomUUID().toString();
        final String methodId = UUID.randomUUID().toString();
        final CreateRestMockResponseRequest request = CreateRestMockResponseRequestTestBuilder.build();
        final CreateRestMockResponseInput input = CreateRestMockResponseRequestConverter.toCreateRestMockResponseInput(request,
                projectId, applicationId, resourceId, methodId);
