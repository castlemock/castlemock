...
public class GraphQLQueryGenerator {
    ...
    public static GraphQLQuery generateGraphQLQuery(){
        final GraphQLQuery query = new GraphQLQuery();
        query.setId("GRAPHQL QUERY TYPE");
        query.setName("Query type name");
        query.setDescription("Description");
        query.setApplicationId("ApplicationId");
        query.setArguments(new ArrayList<GraphQLArgument>());
        return query;
    }
